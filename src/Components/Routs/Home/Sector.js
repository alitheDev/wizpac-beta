...
function Sector(props) {
  ...
  useEffect(() => {
    GetData.Sector().then((res) => {
      res = res.data.data.sector;
      props.setSector(res);
    });
  }, []);
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      cellRenderer: function (params) {
        if (params.value === "nullData") return <Skeleton />;
        else return <Check className="theme_text" />;
      },
    },
    {
    ...
    {
      headerName: "Rating Team",
      hide: columnHide(),
      minWidth: 90,
      field: "managerName1",
      tooltipField: "managerName1",
      // hide: true,
      cellRenderer: cellrandered,
      sortable: true,
      filter: "agSetColumnFilter",
    ...
    <h1 style={{ padding: "10px 20px" }}>
      <Table className="overflow-scroll responsiveTableFonts">
        ...
        <TableRow>
          ...
          <TableCell className="responsiveTableFonts py-1">
            {params.data.db_deadlinedays < 0 ? (
              <span className="text-danger">
                {" "}
                {params.data.db_deadlinedays}{" "}
              </span>
            ) : (
