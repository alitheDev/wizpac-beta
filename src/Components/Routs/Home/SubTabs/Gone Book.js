...
function GoneBook(props) {
  ...
  const GoneBookdatefilters = (startDate, endDate, gridApi, getFilterType) => {
  ...
  function innerNotiDate(params) {
    if (
      params.data.notification_date == null ||
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      cellRenderer: function (params) {
        ...
        return (
          <a
            href={`https://209.97.168.200/pacrawizpackv3/public/admin/pacraWork/${params.data.opinion_id}`}
            target="_blank"
  ...
  return (
    <TableComponent
      ...
      datefilters={GoneBookdatefilters}
      datefilter={true}
    />
  );
}

export default GoneBook;
