...
function DoneRc(props) {
  ...
  const DoneRcdatefilters = (startDate, endDate, gridApi, getFilterType) => {
  ...
  function rc_previous(params) {
    if (params.data.rc_previous == null) {
      return "-";
    } else {
      const date = new Date(params.data.rc_previous);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function ic_previous(params) {
    if (params.data.ic_previous == null) {
      return "-";
    } else {
      const date = new Date(params.data.ic_previous);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function ic_date(params) {
    if (params.data.ic_date == null) {
      return "-";
    } else {
      const date = new Date(params.data.ic_date);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function fc_previous(params) {
    if (params.data.fc_previous == null) {
      return "-";
    } else {
      const date = new Date(params.data.fc_previous);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function fc_date(params) {
    if (params.data.fc_date == null) {
      return "-";
    } else {
      const date = new Date(params.data.fc_date);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function mm_previous(params) {
    if (params.data.mm_previous == null) {
      return "-";
    } else {
      const date = new Date(params.data.mm_previous);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function mm_date(params) {
    if (params.data.mm_date == null) {
      return "-";
    } else {
      const date = new Date(params.data.mm_date);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function sv_previous(params) {
    if (params.data.sv_previous == null) {
      return "-";
    } else {
      const date = new Date(params.data.sv_previous);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
  ...
  function sv_date(params) {
    if (params.data.sv_date == null) {
      return "-";
    } else {
      const date = new Date(params.data.sv_date);
      const yyyy = date.getFullYear();
      const yy = yyyy.toString();
      const y = yy.slice(2, 4);
      let mm = date.toLocaleString("default", { month: "short" });
      ...
      <Table className="overflow-scroll responsiveTableFonts">
        ...
        <TableRow>
          ...
          <TableRow>
            ...
            <TableCell className="responsiveTableFonts py-1">
              {params.data.rc_done === "" || params.data.rc_done == null ? (
                "-"
              ) : params.data.rc_done < 0 ? (
                <span className="text-danger"> {params.data.rc_done} </span>
              ) : (
                <span className="text-success"> {params.data.rc_done} </span>
              )}
            </TableCell>
          </TableRow>
          <TableRow>
  ...
  return (
    <TableComponent
      ...
      datefilters={DoneRcdatefilters}
      datefilter={true}
    />
  );
}

export default DoneRc;
