...
function InstP(props) {
  ...
  const InstPdatefilters = (startDate, endDate, gridApi, getFilterType) => {
      ...
      <Table className="overflow-scroll responsiveTableFonts">
        ...
        <TableRow>
          ...
          <TableCell className="responsiveTableFonts py-1">
            {params.data.shl ? (
              <a
                href={`https://209.97.168.200/pacrawizpackv3/public/admin/finalPr/${params.data.shl}`}
                target="_blank"
                rel="noopener noreferrer"
              >
                <Check className="theme_text" />
