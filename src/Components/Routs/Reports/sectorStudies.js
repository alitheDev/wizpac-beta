...
export default function SectorStudies(props) {
    const [sectorStudies, setSectorStudies] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.SectorStudiesApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setSectorStudies(resp.data);
    };
    ...
    const columnDefs = [
      ...
      {
        headerName: "Name of Sector / Industry",
