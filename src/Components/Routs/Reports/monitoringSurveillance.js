...
export default function MonitoringSurveillance(props) {
    const [monitoringSurveillance, setmonitoringSurveillance] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.MonitoringSurveillanceApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setmonitoringSurveillance(resp.data);
    };
    ...
    const columnDefs = [
      ...
      {
        headerName: "Date of Rating Assigned",
    ...
    return (
      <>
        <TableComponent
          value={"monitoringSurveillance"}
          handleRfreshTab={props.handleRfreshTab}
          Data={monitoringSurveillance}
