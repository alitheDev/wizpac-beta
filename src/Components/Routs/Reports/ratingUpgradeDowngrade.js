...
export default function RatingUpgradeDowngrade(props) {
    const [ratingUpgradeDowngradeApi, setRatingUpgradeDowngradeApi] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.RatingUpgradeDowngradeApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setRatingUpgradeDowngradeApi(resp.data);
    };
    ...
    const columnDefs = [
      ...
      {
        headerName: "Upgraded/Downgraded",
        field: "ratingAction",
        minWidth: 130,
        minWidth: 130,
        sortable: true,
      ...
      {
        headerName: "Date of New Rating Assignened",
        field: "date_rating_assigned",
        minWidth: 115,
        // hide: true,
        sortable: true,
    ...
    return (
      <>
        <TableComponent
          value={"RatingUpgradeDowngrade"}
          handleRfreshTab={props.handleRfreshTab}
          Data={ratingUpgradeDowngradeApi}
