...
export default function LeadRcRotation(props) {
    const [leadRcRotationDetail, setleadRcRotationDetail] = useState([]);
    ...
    useEffect(() => {
      GetGridsApi.LeadRcRotation().then((res) => {
        res = res.data;
        console.log(res, "Lead RC data");
        setleadRcRotationDetail(res);
      });
    }, []);
