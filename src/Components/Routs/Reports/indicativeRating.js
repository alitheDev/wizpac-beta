...
export default function IndicativeRating(props) {
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.IndicativeRatingApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setIndicativeRating(resp.data);
    };
    ...
    const columnDefs = [
      ...
      {
        headerName: "LT Indicative Rating",
        minWidth: responsiveColumns(),
      ...
      {
        headerName: "LT Rating Assigned By RC",
        minWidth: responsiveColumns(),
        field: "finalRating",
        sortable: true,
        filter: "agSetColumnFilter",
      ...
      {
        headerName: "ST Indicative Rating",
        minWidth: responsiveColumns(),
        field: "indicativeRating2_sterm",
        sortable: true,
        filter: "agSetColumnFilter",
        excelMode: "windows",
        cellRenderer: cellrander,
      ...
      {
        headerName: "ST Rating Assigned By RC",
        minWidth: responsiveColumns(),
        field: "finalRating2_sterm",
        sortable: true,
        filter: "agSetColumnFilter",
        excelMode: "windows",
        cellRenderer: cellrander,
