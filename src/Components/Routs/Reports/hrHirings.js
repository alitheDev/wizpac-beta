...
export default function HrHirings(props) {
    const [HrHirings, setHrHirings] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.HrHiringsApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setHrHirings(resp.data);
    };
    ...
    const columnDefs = [
      ...
      {
        headerName: "Experience (Outside PACRA)",
        minWidth: responsiveColumns(),
        field: "exp_outside_pacra",
        sortable: true,
        filter: "agSetColumnFilter",
        excelMode: "windows",
        cellRenderer: cellrander,
      ...
      {
        headerName: "Experience in PACRA",
        minWidth: responsiveColumns(),
        field: "exp_in_pacra",
        sortable: true,
        filter: "agSetColumnFilter",
