...
export default function UnsolicitedRatings(props) {
    const [unsolicitedRatingsApi, setunsolicitedRatingsApi] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.UnsolicitedRatingsApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setunsolicitedRatingsApi(resp.data);
    };
    ...
    return (
      <>
        <TableComponent
          value={"unsolicitedRatingsApi"}
          handleRfreshTab={props.handleRfreshTab}
          Data={unsolicitedRatingsApi}
