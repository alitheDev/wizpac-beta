...
export default function Updatingofmethodologies(props) {
    const [updatingofmethodologies, setupdatingofmethodologies] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.UpdatingofmethodologiesApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setupdatingofmethodologies(resp.data);
    };
    ...
    return (
      <>
        <TableComponent
          value={"updatingofmethodologies"}
          handleRfreshTab={props.handleRfreshTab}
          Data={updatingofmethodologies}
