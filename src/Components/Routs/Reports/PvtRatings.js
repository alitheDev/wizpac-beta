...
export default function PvtRatings(props) {
    const [pvtRatings, setPvtRatings] = useState([]);
    ...
    const getTabsData = async (fromDate, toDate) => {
      const res = GetGridsApi.PvtRatingsApi(fromDate, toDate);
      const resp = await res;
      console.log(resp.data,'ressspppp');
      setPvtRatings(resp.data);
    };
