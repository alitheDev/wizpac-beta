...
export default function AnalystRotation(props) {
    const [analystRotationDetail, setanalystRotationDetail] = useState([]);
    ...
    useEffect(() => {
      GetGridsApi.AnalystRotation().then((res) => {
        res = res.data;
        console.log(res, "analyst data");
        setanalystRotationDetail(res);
      });
    }, []);
