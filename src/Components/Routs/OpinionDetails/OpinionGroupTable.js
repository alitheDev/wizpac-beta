...
function OpinionGroupTable(props) {
  ...
  const OpinionGroupTabledatefilters = (
    startDate,
    endDate,
    gridApi,
    getFilterType
  ...
  const columnDefs = [
    ...
    },
    {
      ...
      cellRenderer: function (params) {
        return (
          <Link
            to={`/OpinionDetails/${params.data.opId}`}
            // target="_blank"
  ...
  return (
    <>
      <NoFiltersTable
        value={"OpinionGroupTable"}
        // stating = {props.stating}
        handleRfreshTab={props.handleRfreshTab}
        Data={props.OpinionGroupTable}
        columnDefs={columnDefs}
        screenWidth={props.screenWidth}
        datefilters={OpinionGroupTabledatefilters}
...
export default OpinionGroupTable;
